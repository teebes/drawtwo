...
urlpatterns = [
    ...
    path(
        "matchmaking/status/<slug:title_slug>/",
        views.matchmaking_queue_status,
        name="matchmaking-status",
    ),
    path(
        "matchmaking/leave/<slug:title_slug>/",
        views.leave_matchmaking_queue,
        name="leave-matchmaking-queue",
    ),
    # Friendly challenges
    path(
        "challenges/", views.create_friendly_challenge, name="friendly-challenge-create"
    ),
    path(
        "challenges/pending/<slug:title_slug>/",
        views.list_pending_friendly_challenges,
        name="friendly-challenge-pending",
    ),
    path(
        "challenges/<int:challenge_id>/accept/",
        views.accept_friendly_challenge,
        name="friendly-challenge-accept",
    ),
    path(
    ...
    path(
        "<slug:title_slug>/my-rating/",
        UserTitleRatingView.as_view(),
        name="user-title-rating",
    ),
]
